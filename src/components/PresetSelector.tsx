            ...
            >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="rounded-md border border-film-500 px-2 py-1 text-xs text-film-600 hover:bg-film-50"
                >
                  Apply
                </button>
                ...
                <button
                  ...
                  className="rounded-md border border-red-400 px-2 py-1 text-xs text-red-500 hover:bg-red-50"
                >
                  Delete
                </button>
              </div>
